    ...
    <section id="contact" className="bg-gray-100 py-16">
      <div className="container mx-auto px-6 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          ...
          <div className="flex flex-col items-center">
            <a
              href={`sms:+19099097204?body=${encodeURIComponent("Hello there, I need help with my assignment")}`} 
              className="text-3xl text-gray-700 hover:text-green-500 transition"
              aria-label="Chat with us on WhatsApp"
            >
              <FaCommentAlt />
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                onClick={() => copyToClipboard('+1 (909) 909-7204',"text")} 
                className="text-gray-700 hover:text-green-500"
                aria-label="Copy WhatsApp number"
              >
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                onClick={() => copyToClipboard('+19099097204',"whatsapp")} 
                className="text-gray-700 hover:text-green-500"
                aria-label="Copy WhatsApp number"
              >
                {(copied && copyId==="whatsapp")? <FaCheck /> : <FaClipboard />}
          ...
          <div className="flex flex-col items-center">
            <a
              href="mailto:scorelinewriters54@gmail.com" 
              className="text-3xl text-gray-700 hover:text-blue-500 transition"
              aria-label="Send us an email"
            >
              <FaEnvelope />
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                onClick={() => copyToClipboard('scorelinewriters54@gmail.com',"email")} 
                className="text-gray-700 hover:text-blue-500"
                aria-label="Copy email address"
              >
                {(copied && copyId==="email") ? <FaCheck /> : <FaClipboard />}
